...
Программа должна считывать введенные пользователем вес в килограммах и рост
в метрах и выводить на экран сообщение о индексе массы тела.
...
public class Solution {
    ...
    public static class Body {
        public static void massIndex(double weight, double height) {
           double ix = weight/(height*height);
            if (ix<18.5) System.out.println("Недовес: меньше чем 18.5");
            else if (ix<25) System.out.println("Нормальный: между 18.5 и 24.9");
            else if (ix<30) System.out.println("Избыточный вес: между 25 и 29.9");
