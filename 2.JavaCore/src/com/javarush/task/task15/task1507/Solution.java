...
public class Solution {
    ...
    public static void printMatrix(short n, Object value, int m) {
        for (int i = 0; i < m; i++) {
            for (int j = 0; j < n; j++) {
                System.out.print(value);
            }
    ...
    public static void printMatrix(short n, Object value, short m) {
        for (int i = 0; i < m; i++) {
            for (int j = 0; j < n; j++) {
                System.out.print(value);
            }
    ...
    public static void printMatrix(int n, Object value, short m) {
        for (int i = 0; i < m; i++) {
            for (int j = 0; j < n; j++) {
                System.out.print(value);
            }
